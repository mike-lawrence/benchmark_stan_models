...
sim_pars = lst(
	...
	, num_trials = 3 #number of trials per subject/condition combo, must be an integer >1
...
aria:::check_syntax_and_maybe_compile('stan/hwg_nc_slow.stan')

# compose
aria::compose(
	data = data_for_stan
	, code_path = 'stan/hwg_nc_slow.stan'
	, out_path = 'nc/hwg_nc_slow.nc'
	, overwrite = T
)
